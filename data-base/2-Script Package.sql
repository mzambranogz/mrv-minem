 ...
 PROCEDURE SP_SEL_INICIATIVAS_RPT(
  ...
  BEGIN
        ...
        SELECT
                        ...
                        (SELECT NVL(SUM(REDUCIDO),0) FROM T_GENM_ACUMULADO WHERE ID_INICIATIVA IN (NVL((SELECT INIC.ID_INICIATIVA FROM T_GENM_INICIATIVA INIC WHERE INIC.ASOCIADO_ACCION = I.ID_INICIATIVA),0))) + (SELECT SUM(REDUCIDO) FROM T_GENM_ACUMULADO WHERE ID_INICIATIVA = I.ID_INICIATIVA) GEI_TOTAL,
                        --(SELECT SUM(REDUCIDO) FROM T_GENM_ACUMULADO WHERE ID_INICIATIVA = I.ID_INICIATIVA) GEI_TOTAL,
                        
                        (SELECT NVL(SUM(INVERSION),0) FROM T_GEND_INICIATIVA_INVERSION WHERE ID_INICIATIVA IN (NVL((SELECT INIC.ID_INICIATIVA FROM T_GENM_INICIATIVA INIC WHERE INIC.ASOCIADO_ACCION = I.ID_INICIATIVA),0))) + (SELECT NVL(SUM(INVERSION),0) FROM T_GEND_INICIATIVA_INVERSION WHERE ID_INICIATIVA = I.ID_INICIATIVA) INVERSION_INICIATIVA,
