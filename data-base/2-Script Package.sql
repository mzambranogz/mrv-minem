  ...
  BEGIN
   ...
   PROCEDURE USP_PRC_MOSTRAR_ACUMULADOR(
    ...
    BEGIN
        ...
        NVL((SELECT MIN(VALOR) FROM T_MAEM_INDICADOR_DATA 
        WHERE ID_MEDMIT = 4 AND ID_INICIATIVA = INI.ID_INICIATIVA AND ID_PARAMETRO = 92 AND ID_INDICADOR IN (SELECT ID_INDICADOR FROM T_MAEM_INDICADOR_DATA WHERE ID_MEDMIT = 4 AND ID_INICIATIVA = INI.ID_INICIATIVA AND ID_PARAMETRO = 91 AND VALOR = 3)),'-') FECHA_VERIFICADA,
        NVL((SELECT SUM(TO_NUMBER(NVL(VALOR,0.0),'9999999999990.0000000000000000')) FROM T_MAEM_INDICADOR_DATA 
        ...
        WHERE INI.ID_MEDMIT = 4 AND NVL(FLG_ESTADO,'1') = '1';
