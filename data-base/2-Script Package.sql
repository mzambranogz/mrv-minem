 ...
 PROCEDURE USP_PRC_INICIATIVA_AUDITORIA(
    ...
    BEGIN
        ...
        ELSE
            ...
            INSERT INTO T_GEND_INICIATIVA_AUDITORIA (ID_AUDITORIA, ID_INICIATIVA, SECTOR_INST, INSTITUCION_AUDITADA, TIPO_AUDITORIA, AUDITOR, NOMBRE_INSTITUCION, FECHA_AUDITORIA)
            VALUES (vContador, PI_ID_INICIATIVA, PI_SECTOR_INST, PI_INSTITUCION_AUDITADA, PI_TIPO_AUDITORIA, PI_AUDITOR, PI_NOMBRE_INSTITUCION, PI_FECHA_AUDITORIA);
        END IF;
