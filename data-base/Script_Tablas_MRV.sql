...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "USERMRV"."SQ_GEND_DETALLE_INICIATIVA"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 81 CACHE 20 NOORDER  NOCYCLE   ;
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "USERMRV"."SQ_GEND_INDICADOR"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 61 CACHE 20 NOORDER  NOCYCLE   ;
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "USERMRV"."SQ_GEND_INICIATIVA_ARCHIVO"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE   ;
--------------------------------------------------------
--  DDL for Sequence SQ_GEND_INICIATIVA_ENERG
--------------------------------------------------------

   CREATE SEQUENCE  "USERMRV"."SQ_GEND_INICIATIVA_ENERG"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 141 CACHE 20 NOORDER  NOCYCLE   ;
--------------------------------------------------------
--  DDL for Sequence SQ_GEND_INICIATIVA_GEI
--------------------------------------------------------

   CREATE SEQUENCE  "USERMRV"."SQ_GEND_INICIATIVA_GEI"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 161 CACHE 20 NOORDER  NOCYCLE   ;
--------------------------------------------------------
--  DDL for Sequence SQ_GEND_INICIATIVA_UBICACION
--------------------------------------------------------

   CREATE SEQUENCE  "USERMRV"."SQ_GEND_INICIATIVA_UBICACION"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 181 CACHE 20 NOORDER  NOCYCLE   ;
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "USERMRV"."SQ_GENM_ESCENARIO"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 41 CACHE 20 NOORDER  NOCYCLE   ;
--------------------------------------------------------
--  DDL for Sequence SQ_GENM_INICIATIVA
--------------------------------------------------------

   CREATE SEQUENCE  "USERMRV"."SQ_GENM_INICIATIVA"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 141 CACHE 20 NOORDER  NOCYCLE   ;
--------------------------------------------------------
--  DDL for Sequence SQ_GENM_INSTITUCION
--------------------------------------------------------

   CREATE SEQUENCE  "USERMRV"."SQ_GENM_INSTITUCION"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 141 CACHE 20 NOORDER  NOCYCLE   ;
--------------------------------------------------------
--  DDL for Sequence SQ_GENM_NOTIFICACION
--------------------------------------------------------

   CREATE SEQUENCE  "USERMRV"."SQ_GENM_NOTIFICACION"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 41 CACHE 20 NOORDER  NOCYCLE   ;
--------------------------------------------------------
--  DDL for Sequence SQ_GENM_USUARIO
--------------------------------------------------------

   CREATE SEQUENCE  "USERMRV"."SQ_GENM_USUARIO"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 141 CACHE 20 NOORDER  NOCYCLE   ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE TABLE "USERMRV"."T_GEND_ARCHIVO" 
   (	"ID_ARCHIVO" NUMBER(*,0), 
...
--------------------------------------------------------
  ...
  CREATE TABLE "USERMRV"."T_GEND_INICIATIVA_ARCHIVO" 
...
--------------------------------------------------------
  ...
  CREATE TABLE "USERMRV"."T_GENM_NOTIFICACION" 
   (	"ID_NOTIFICACION" NUMBER(*,0), 
	...
	"ID_ROL" NUMBER(*,0), 
	"ID_USUARIO" NUMBER(*,0), 
	"FLG_VISTO" VARCHAR2(1 BYTE) DEFAULT 0, 
	"FECHA_VISTO" DATE, 
...
--------------------------------------------------------
  ...
  CREATE TABLE "USERMRV"."T_MAE_F_REN" 
   (	"ID_F_REN" NUMBER(*,0), 
	"ID_TIPO_VEHICULO" NUMBER(*,0), 
	"ID_TIPO_FUENTE" NUMBER(*,0), 
	"FACTOR" NUMBER(18,4)
...
--------------------------------------------------------
  ...
  CREATE INDEX "USERMRV"."GEND_INICIATIVA_ARCHIVO_PK" ON "USERMRV"."T_GEND_INICIATIVA_ARCHIVO" ("ID_INICIATIVA_ARCHIVO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  TABLESPACE "USERS" ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE TRIGGER "USERMRV"."TR_GEND_INICIATIVA_ARCHIVO" 
...
END;
/
ALTER TRIGGER "USERMRV"."TR_GEND_INICIATIVA_ARCHIVO" ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE TRIGGER "USERMRV"."TR_GENM_ESCENARIO" 
...
END;
/
ALTER TRIGGER "USERMRV"."TR_GENM_ESCENARIO" ENABLE;
--------------------------------------------------------
