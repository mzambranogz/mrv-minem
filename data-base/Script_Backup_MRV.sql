...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "USERMRV"."SQ_GEND_INICIATIVA_ENERG"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 21 CACHE 20 NOORDER  NOCYCLE   ;
--------------------------------------------------------
--  DDL for Sequence SQ_GEND_INICIATIVA_GEI
--------------------------------------------------------

   CREATE SEQUENCE  "USERMRV"."SQ_GEND_INICIATIVA_GEI"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 21 CACHE 20 NOORDER  NOCYCLE   ;
--------------------------------------------------------
--  DDL for Sequence SQ_GEND_INICIATIVA_UBICACION
--------------------------------------------------------

   CREATE SEQUENCE  "USERMRV"."SQ_GEND_INICIATIVA_UBICACION"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 21 CACHE 20 NOORDER  NOCYCLE   ;
--------------------------------------------------------
--  DDL for Sequence SQ_GENM_INICIATIVA
--------------------------------------------------------

   CREATE SEQUENCE  "USERMRV"."SQ_GENM_INICIATIVA"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 21 CACHE 20 NOORDER  NOCYCLE   ;
--------------------------------------------------------
--  DDL for Sequence SQ_GENM_INSTITUCION
--------------------------------------------------------

   CREATE SEQUENCE  "USERMRV"."SQ_GENM_INSTITUCION"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 41 CACHE 20 NOORDER  NOCYCLE   ;
--------------------------------------------------------
--  DDL for Sequence SQ_GENM_USUARIO
--------------------------------------------------------

   CREATE SEQUENCE  "USERMRV"."SQ_GENM_USUARIO"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 41 CACHE 20 NOORDER  NOCYCLE   ;
--------------------------------------------------------
--  DDL for Table T_GEND_DETALLE_INDICADOR
--------------------------------------------------------

  CREATE TABLE "USERMRV"."T_GEND_DETALLE_INDICADOR" 
   (	"ID_DETALLE_INDICADOR" NUMBER(*,0), 
...
--------------------------------------------------------
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "USERS" ;
--------------------------------------------------------
--  DDL for Table T_GENM_FACTOR_VALOR
--------------------------------------------------------

  CREATE TABLE "USERMRV"."T_GENM_FACTOR_VALOR" 
...
--------------------------------------------------------
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "USERS" ;
--------------------------------------------------------
--  DDL for Table T_GENM_VARIABLE_VALOR
--------------------------------------------------------

  CREATE TABLE "USERMRV"."T_GENM_VARIABLE_VALOR" 
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE   TRIGGER "USERMRV"."TR_GEND_INICIATIVA_ENERG" 
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE   TRIGGER "USERMRV"."TR_GEND_INICIATIVA_GEI" 
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE   TRIGGER "USERMRV"."TR_GEND_INICIATIVA_UBICACION" 
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE   TRIGGER "USERMRV"."TR_GENM_INICIATIVA" 
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE   TRIGGER "USERMRV"."TR_GENM_INSTITUCION" 
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE   TRIGGER "USERMRV"."TR_GENM_USUARIO" 
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE   PACKAGE "USERMRV"."PKG_MRV_ADMIN_SISTEMA" AS 
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE   PACKAGE "USERMRV"."PKG_MRV_DETALLE_INDICADORES" AS 
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE   PACKAGE "USERMRV"."PKG_MRV_INICIATIVA_MITIGACION" AS 
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE   PACKAGE "USERMRV"."PKG_MRV_MANTENIMIENTO" AS 
...
PROCEDURE USP_SEL_LISTA_MEDMITIGACION(
        pRefcursor  OUT SYS_REFCURSOR
   );
   
    PROCEDURE USP_SEL_MEDMITIGACION(
        pID_MEDMIT IN NUMBER,
        pRefcursor  OUT SYS_REFCURSOR
   );
   
    PROCEDURE USP_UPD_MEDMITIGACION(
       pID_MEDMIT IN NUMBER,
    ...
    PROCEDURE USP_DEL_MEDMITIGACION(
       pID_MEDMIT IN NUMBER
   );
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE   PACKAGE "USERMRV"."PKG_MRV_PUBLICO" AS 
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE   PACKAGE BODY "USERMRV"."PKG_MRV_ADMIN_SISTEMA" AS
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE   PACKAGE BODY "USERMRV"."PKG_MRV_DETALLE_INDICADORES" AS
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE   PACKAGE BODY "USERMRV"."PKG_MRV_INICIATIVA_MITIGACION" AS
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE   PACKAGE BODY "USERMRV"."PKG_MRV_MANTENIMIENTO" AS
...
PROCEDURE USP_SEL_LISTA_MEDMITIGACION(
  ...
  END USP_SEL_LISTA_MEDMITIGACION;
  ...
  PROCEDURE USP_SEL_MEDMITIGACION(
    ...
    END USP_SEL_MEDMITIGACION;
    
    
    
    PROCEDURE USP_UPD_MEDMITIGACION(                  /*actualizar*/
        pID_MEDMIT IN NUMBER,
        pNUMERO_MEDMIT IN VARCHAR2,
	    pNOMBRE_MEDMIT IN VARCHAR2,
	    pDESCRIPCION_MEDMIT IN VARCHAR2,
    ...
    END USP_UPD_MEDMITIGACION;
    
    
     PROCEDURE USP_DEL_MEDMITIGACION(                  /*Eliminar*/
        pID_MEDMIT IN NUMBER
   )AS
     BEGIN
             UPDATE T_MAE_MEDMIT
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE   PACKAGE BODY "USERMRV"."PKG_MRV_PUBLICO" AS
...
--------------------------------------------------------
--  Constraints for Table T_GENM_FACTOR_VALOR
--------------------------------------------------------

  ALTER TABLE "USERMRV"."T_GENM_FACTOR_VALOR" MODIFY ("ID_FACTOR" NOT NULL ENABLE);
  ALTER TABLE "USERMRV"."T_GENM_FACTOR_VALOR" MODIFY ("ID_FACTOR_VALOR" NOT NULL ENABLE);
--------------------------------------------------------
