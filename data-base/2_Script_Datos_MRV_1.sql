--------------------------------------------------------------------------------------------------------------------------------------------------------
-- Archivo creado  - jueves-mayo-21-2020   
--------------------------------------------------------
...
Insert into MRVMM.T_MAE_ENERG (ID_ENERG,DESCRIPCION,FLAG_ESTADO) values ('3','COMBUSTIBLES SOLIDOS (BIOMASA)',null);
...
Insert into MRVMM.T_MAE_PLAZO_ETAPA_ESTADO (ID_PLAZO_ETAPA_ESTADO,ID_ETAPA,ID_ESTADO,DESCRIPCION,PLAZO,ID_ROL,SIG_ROL) values ('14','5','3','Iniciativa de mitigación y su detalle aprobado por el Administrador MRV','30','3','3');
...
Insert into MRVMM.T_MAE_TIPO_INICIATIVA (ID_TIPO_INICIATIVA,TIPO_INICIATIVA,FLAG_ESTADO) values ('3','ITMO','1');
Insert into MRVMM.T_MAE_TIPO_INICIATIVA (ID_TIPO_INICIATIVA,TIPO_INICIATIVA,FLAG_ESTADO) values ('1','Comercialización Internacional','1');
Insert into MRVMM.T_MAE_TIPO_INICIATIVA (ID_TIPO_INICIATIVA,TIPO_INICIATIVA,FLAG_ESTADO) values ('2','Comercialización Nacional','1');
Insert into MRVMM.T_MAE_TIPO_INICIATIVA (ID_TIPO_INICIATIVA,TIPO_INICIATIVA,FLAG_ESTADO) values ('4','MDL','1');
Insert into MRVMM.T_MAE_TIPO_INICIATIVA (ID_TIPO_INICIATIVA,TIPO_INICIATIVA,FLAG_ESTADO) values ('5','Mercado Voluntario','1');
Insert into MRVMM.T_MAE_TIPO_INICIATIVA (ID_TIPO_INICIATIVA,TIPO_INICIATIVA,FLAG_ESTADO) values ('6','NDC','1');
