...
Insert into MRVMM.T_GEND_DETALLE_INICIATIVA (ID_DETALLE_INICIATIVA,ID_INICIATIVA,ID_REMITENTE,ID_DESTINO,DESC_INICIATIVA,ID_ETAPA,ID_ESTADO,OBSERVACIONES,FECHA_DERIVACION,FECHA_RECEPCION) values ('1721','741','320','81','REGISTRO INICIATIVA','1','1',' Reemplazo de lámparas en sector público - LSP 23|Reemplazo de lámparas en sector público - LSP|23/05/0217|DOLARES|4343,53',to_date('14/05/20','DD/MM/RR'),null);
Insert into MRVMM.T_GEND_DETALLE_INICIATIVA (ID_DETALLE_INICIATIVA,ID_INICIATIVA,ID_REMITENTE,ID_DESTINO,DESC_INICIATIVA,ID_ETAPA,ID_ESTADO,OBSERVACIONES,FECHA_DERIVACION,FECHA_RECEPCION) values ('1722','741','81',null,null,'2','3','CH4|ENERGIA SOLAR',to_date('14/05/20','DD/MM/RR'),null);
...
Insert into MRVMM.T_GEND_INICIATIVA_ENERG (ID_INICIATIVA_ENERG,ID_INICIATIVA,ID_ENERG,FLAG_ESTADO) values ('701','741','4','1');

Insert into MRVMM.T_GEND_INICIATIVA_GEI (ID_INICIATIVA_GEI,ID_INICIATIVA,ID_GEI,FLAG_ESTADO) values ('801','741','2','1');

Insert into MRVMM.T_GEND_INICIATIVA_UBICACION (ID_INICIATIVA_UBICACION,ID_INICIATIVA,ID_UBICACION,FLAG_ESTADO) values ('1144','741','4','1');
Insert into MRVMM.T_GEND_INICIATIVA_UBICACION (ID_INICIATIVA_UBICACION,ID_INICIATIVA,ID_UBICACION,FLAG_ESTADO) values ('1145','741','5','1');
Insert into MRVMM.T_GEND_INICIATIVA_UBICACION (ID_INICIATIVA_UBICACION,ID_INICIATIVA,ID_UBICACION,FLAG_ESTADO) values ('1146','741','6','1');
Insert into MRVMM.T_GEND_INICIATIVA_UBICACION (ID_INICIATIVA_UBICACION,ID_INICIATIVA,ID_UBICACION,FLAG_ESTADO) values ('1147','741','7','1');
Insert into MRVMM.T_GEND_INICIATIVA_UBICACION (ID_INICIATIVA_UBICACION,ID_INICIATIVA,ID_UBICACION,FLAG_ESTADO) values ('1148','741','8','1');
Insert into MRVMM.T_GEND_INICIATIVA_UBICACION (ID_INICIATIVA_UBICACION,ID_INICIATIVA,ID_UBICACION,FLAG_ESTADO) values ('1149','741','9','1');
Insert into MRVMM.T_GEND_INICIATIVA_UBICACION (ID_INICIATIVA_UBICACION,ID_INICIATIVA,ID_UBICACION,FLAG_ESTADO) values ('1150','741','10','1');
Insert into MRVMM.T_GEND_INICIATIVA_UBICACION (ID_INICIATIVA_UBICACION,ID_INICIATIVA,ID_UBICACION,FLAG_ESTADO) values ('1151','741','11','1');
Insert into MRVMM.T_GEND_INICIATIVA_UBICACION (ID_INICIATIVA_UBICACION,ID_INICIATIVA,ID_UBICACION,FLAG_ESTADO) values ('1153','741','13','1');
Insert into MRVMM.T_GEND_INICIATIVA_UBICACION (ID_INICIATIVA_UBICACION,ID_INICIATIVA,ID_UBICACION,FLAG_ESTADO) values ('1154','741','14','1');
Insert into MRVMM.T_GEND_INICIATIVA_UBICACION (ID_INICIATIVA_UBICACION,ID_INICIATIVA,ID_UBICACION,FLAG_ESTADO) values ('1155','741','15','1');
Insert into MRVMM.T_GEND_INICIATIVA_UBICACION (ID_INICIATIVA_UBICACION,ID_INICIATIVA,ID_UBICACION,FLAG_ESTADO) values ('1156','741','16','1');
Insert into MRVMM.T_GEND_INICIATIVA_UBICACION (ID_INICIATIVA_UBICACION,ID_INICIATIVA,ID_UBICACION,FLAG_ESTADO) values ('1157','741','17','1');
Insert into MRVMM.T_GEND_INICIATIVA_UBICACION (ID_INICIATIVA_UBICACION,ID_INICIATIVA,ID_UBICACION,FLAG_ESTADO) values ('1158','741','18','1');
Insert into MRVMM.T_GEND_INICIATIVA_UBICACION (ID_INICIATIVA_UBICACION,ID_INICIATIVA,ID_UBICACION,FLAG_ESTADO) values ('1159','741','19','1');
Insert into MRVMM.T_GEND_INICIATIVA_UBICACION (ID_INICIATIVA_UBICACION,ID_INICIATIVA,ID_UBICACION,FLAG_ESTADO) values ('1161','741','21','1');
Insert into MRVMM.T_GEND_INICIATIVA_UBICACION (ID_INICIATIVA_UBICACION,ID_INICIATIVA,ID_UBICACION,FLAG_ESTADO) values ('1162','741','22','1');
Insert into MRVMM.T_GEND_INICIATIVA_UBICACION (ID_INICIATIVA_UBICACION,ID_INICIATIVA,ID_UBICACION,FLAG_ESTADO) values ('1163','741','23','1');
Insert into MRVMM.T_GEND_INICIATIVA_UBICACION (ID_INICIATIVA_UBICACION,ID_INICIATIVA,ID_UBICACION,FLAG_ESTADO) values ('1164','741','24','1');
Insert into MRVMM.T_GEND_INICIATIVA_UBICACION (ID_INICIATIVA_UBICACION,ID_INICIATIVA,ID_UBICACION,FLAG_ESTADO) values ('1165','741','25','1');
Insert into MRVMM.T_GEND_INICIATIVA_UBICACION (ID_INICIATIVA_UBICACION,ID_INICIATIVA,ID_UBICACION,FLAG_ESTADO) values ('1142','741','2','1');
Insert into MRVMM.T_GEND_INICIATIVA_UBICACION (ID_INICIATIVA_UBICACION,ID_INICIATIVA,ID_UBICACION,FLAG_ESTADO) values ('1143','741','3','1');
Insert into MRVMM.T_GEND_INICIATIVA_UBICACION (ID_INICIATIVA_UBICACION,ID_INICIATIVA,ID_UBICACION,FLAG_ESTADO) values ('1160','741','20','1');
Insert into MRVMM.T_GEND_INICIATIVA_UBICACION (ID_INICIATIVA_UBICACION,ID_INICIATIVA,ID_UBICACION,FLAG_ESTADO) values ('1141','741','1','1');
Insert into MRVMM.T_GEND_INICIATIVA_UBICACION (ID_INICIATIVA_UBICACION,ID_INICIATIVA,ID_UBICACION,FLAG_ESTADO) values ('1152','741','12','1');
...
Insert into MRVMM.T_GENM_INICIATIVA (ID_INICIATIVA,ID_MEDMIT,ID_USUARIO,NOMBRE_INICIATIVA,DESC_INICIATIVA,ID_ESTADO,PRIVACIDAD_INICIATIVA,INVERSION_INICIATIVA,ID_MONEDA,FECHA_CREA_INICIATIVA,FECHA_IMPLE_INICIATIVA,ID_ETAPA,USUARIO_REGISTRO,FECHA_REGISTRO,IP_REGISTRO,USUARIO_MODIFICA,FECHA_MODIFICA,IP_MODIFICA,FLG_ESTADO,PRIVACIDAD_INVERSION,FECHA_FIN_INICIATIVA,GEI_TOTAL,ID_TIPO_INGRESO,ID_TIPO_INICIATIVA,ID_PLAZO_ETAPA_ESTADO,ASIGNAR_INI,ESTADO_FICHA,NOMBRE_FICHA) values ('741','6','320',' Reemplazo de lámparas en sector público - LSP 23',' Reemplazo de lámparas en sector público - LSP','3','0','4343,53','2',to_date('14/05/20','DD/MM/RR'),to_date('23/05/17','DD/MM/RR'),'2',null,to_date('14/05/20','DD/MM/RR'),null,null,null,null,null,'0',to_date('01/01/01','DD/MM/RR'),'0',null,'2','6',null,null,null);
...
Insert into MRVMM.T_GENM_NOTIFICACION (ID_NOTIFICACION,ID_INICIATIVA,ID_ETAPA,ID_ESTADO,FECHA_REGISTRO,ID_ROL,ID_USUARIO,FLG_VISTO,FECHA_VISTO,ID_USUARIO_VISTO,DESCRIPCION,ID_ESTADO_NOTIFICACION,ID_USUARIO_REMITENTE) values ('1381','741','1','1',to_date('14/05/20','DD/MM/RR'),'2','81','0',null,null,'La iniciativa de la entidad Cooperativa de ahorro ha sido registrado correctamente y requiere su revisión','0','320');
Insert into MRVMM.T_GENM_NOTIFICACION (ID_NOTIFICACION,ID_INICIATIVA,ID_ETAPA,ID_ESTADO,FECHA_REGISTRO,ID_ROL,ID_USUARIO,FLG_VISTO,FECHA_VISTO,ID_USUARIO_VISTO,DESCRIPCION,ID_ESTADO_NOTIFICACION,ID_USUARIO_REMITENTE) values ('1382','741','2','3',to_date('14/05/20','DD/MM/RR'),'1','320','0',null,null,'Su iniciativa fue revisada y aprobada','3','81');
