...
namespace MRVMinem.Controllers
{
    ...
    public class GestionController : BaseController
    {
        ...
        public ActionResult DetalleIndicador(int id, int ini)
        {
            ...
            if (validar == 6 || validar == 7 || validar == 8 || validar == 12 || validar == 13 || validar == 14 || validar == 15 || validar == 16 || validar == 18 || validar == 19 || validar == 20 || validar == 21 || validar == 22 || Convert.ToInt16(Session["rol"]) == 7) //add 14-10-20
            {
                IniciativaBE inic = new IniciativaBE();
