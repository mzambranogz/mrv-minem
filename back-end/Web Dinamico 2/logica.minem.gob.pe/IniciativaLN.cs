...
namespace logica.minem.gob.pe
{
    public static class IniciativaLN
    {
        ...
        public static List<IniciativaBE> MostrarUsuarioRecordatorio(IniciativaBE entidad)
        {
            return iniciativaDA.MostrarUsuarioRecordatorio(entidad);
        }

        public static IniciativaBE IniciativaMitigacionRecordatorio(int cod)
        {
        ...
        public static IniciativaBE ValidarRevisionIniciativa(IniciativaBE entidad)
        {
            return iniciativaDA.ValidarRevisionIniciativa(entidad);
        }

        public static int ValidarVista(int id)
        {
            return iniciativaDA.ValidarVista(id);
        }

        public static List<IniciativaBE> ListaIniciativaFicha(IniciativaBE entidad)
        {
