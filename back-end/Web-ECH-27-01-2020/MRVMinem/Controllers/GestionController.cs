...
namespace MRVMinem.Controllers
{
    public class GestionController : BaseController
    {
        ...
        /// <summary>
        /// REGISTRA UNA NUEVA INICIATIVA DE MITIGACIÓN (EL ADMINISTRADO)
        /// </summary>
        /// <param name="entidad">Datos de la iniciativa registrada por el administrado</param>
        /// <returns>Objeto ResponseEntity con el estado de la operación</returns>
        ...
        public JsonResult AprobarIniciativaMitigacion(IniciativaBE entidad)
        {
            ...
            itemRespuesta.success = entidad.OK;
            itemRespuesta.extra = entidad.OK ? "1" : "0";   //26.01.2020
            return Respuesta(itemRespuesta);
        }
